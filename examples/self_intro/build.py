...
if not _IMPLEMENTATION_PATH.exists():
    raise FileNotFoundError(f"Expected self-intro example implementation at {_IMPLEMENTATION_PATH}")

_spec = importlib.util.spec_from_file_location("paperops_examples_self_intro_impl", _IMPLEMENTATION_PATH)
if _spec is None or _spec.loader is None:
    raise ImportError(f"Cannot load self-intro example implementation from {_IMPLEMENTATION_PATH}")
